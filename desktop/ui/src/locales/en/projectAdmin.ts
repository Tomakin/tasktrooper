...
export const projectAdmin = {
  projectSettings: {
    ...
    branchFlow: {
      ...
      description: "When set, a task whose code review passes is merged into this branch first and waits there until that deploy finishes — only then does it reach QA. After you approve it in Human UAT, its own pull request is merged into the release branch and the task is released once that deploy finishes. Leave the integration branch empty for the ordinary single-stage flow.",
      branchLabel: "Integration branch",
      branchPlaceholder: "development",
      releaseLabel: "Release branch",
      releasePlaceholder: "the default branch",
      enabled: "On: {branch} → {release}",
      disabled: "Off",
