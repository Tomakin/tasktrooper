...
export const projectAdmin: ProjectAdminDict = {
  projectSettings: {
    ...
    branchFlow: {
      ...
      description: "Tanımlandığında, code review'dan geçen görev önce bu dala birleştirilir ve dalın deploy süreci tamamlanana kadar bekler; ancak ondan sonra QA'ya ulaşır. Human UAT'ta onayladığınızda görevin kendi pull request'i yayın dalına birleştirilir ve o deploy da tamamlanınca görev Released sütununa geçer. Tek aşamalı akış için entegrasyon dalını boş bırakın.",
      branchLabel: "Entegrasyon dalı",
      branchPlaceholder: "development",
      releaseLabel: "Yayın dalı",
      releasePlaceholder: "varsayılan dal",
      enabled: "Açık: {branch} → {release}",
      disabled: "Kapalı",
